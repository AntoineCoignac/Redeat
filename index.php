    ...
    <nav class="ctn">
        ...
        <a href="./" class="logo-mobile">                       
            <svg width="27" height="24" viewBox="0 0 27 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M0.880005 24V0.480011H5.424V24H0.880005ZM15.152 24L7.984 13.824H13.072L20.464 24H15.152ZM4.08 16.192V12.512H10.032C10.864 12.512 11.5787 12.3413 12.176 12C12.7947 11.6587 13.2747 11.1787 13.616 10.56C13.9573 9.94134 14.128 9.23734 14.128 8.44801C14.128 7.63734 13.9573 6.92268 13.616 6.30401C13.2747 5.68534 12.7947 5.20534 12.176 4.86401C11.5787 4.52268 10.864 4.35201 10.032 4.35201H4.08V0.480011H9.552C11.4293 0.480011 13.0507 0.757343 14.416 1.31201C15.8027 1.86668 16.8693 2.70934 17.616 3.84001C18.3627 4.97068 18.736 6.38934 18.736 8.09601V8.60801C18.736 10.336 18.352 11.7547 17.584 12.864C16.8373 13.9733 15.7813 14.8053 14.416 15.36C13.0507 15.9147 11.4293 16.192 9.552 16.192H4.08Z" fill="black"./>
                <path d="M21.8953 24V18.88H24.6873C25.9023 18.88 26.8873 19.865 26.8873 21.08V24H21.8953Z" fill="#10643C"./>
                </g>
                <defs>
    ...
    <main>
            ...
            <div class="card-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="text-wrapper">
                        ...
                        <div class="schedule">
                            <p class="label">Horaires de retrait</p>
                            <div class="table">
                                <p id="monday" class="day">Lundi : </p>
                                <p id="tuesday" class="day">Mardi : </p>
                                <p id="wednesday" class="day">Mercredi : </p>
                                <p id="thursday" class="day">Jeudi : </p>
                                <p id="friday" class="day">Vendredi : </p>
                                <p id="saturday" class="day">Samedi : </p>
                                <p id="sunday" class="day">Dimanche : </p>
                            </div>
                        </div>
                        <div class="stock">
                            <p class="label">Stock du jour</p>
                            <p class="text"></p>
                        </div>
                        <a href="" class="btn fw">
        ...
        <div class="how ctn">
            <div class="wrapper">
                ...
                <ol>
                    <li>Trouvez un commerçant</li>
                    <li>Munissez-vous de votre carte étudiant</li>
                    <li>Rendez-vous à l’horaire de retrait</li>
                </ol>
                <a href="" class="btn">
